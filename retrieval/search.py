...
class SemanticSearch:
    ...
    def _detect_query_intent(cls, query):
        ...
        Detect broad retrieval intent using transparent precedence rules.



        Specific intent signals are evaluated before generic question

        wording. This prevents phrases such as "how does" or "what does"

        from incorrectly classifying code-behavior questions as
